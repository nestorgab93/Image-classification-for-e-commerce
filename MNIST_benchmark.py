...
# ___________________________ resize data _________________________
...
# _______________________ plot sample or images _____________________
...
#     plt.subplot(np.sqrt(number),np.sqrt(number),i)
#     plt.title(class_names[test_labels[i]],fontsize=10)
#     plt.imshow(resized_test[i,:,:],cmap=plt.cm.binary)
#     plt.xticks([])
#     plt.yticks([])
# plt.show()
...
for i in range(2):
    ...
    for i in range(1,number+1):
        ...
        plt.title(bars[test_labels[selection[i-1]]],fontsize=8)
        ...
        plt.xticks(range(10), bars, fontsize=8)
    plt.show()
